    ...
    <section id="caracteristicas">
      <div className="section-container-char">
        <div className="text-container-char">
          ...
          <p>
            <span>- Código Abierto:</span> su código fuente está disponible para el público.
            ...
            <br />
            <br />
            <span>- Estabilidad y Rendimiento:</span> Linux es conocido por su estabilidad y
            ...
            <br />
            <br />
            <span>- Multitarea y Multiusuario:</span> puede ejecutar múltiples procesos
            simultáneamente y admitir varios usuarios conectados al sistema al
            mismo tiempo.
            <br />
            <br />
            <span>- Seguridad:</span> su estructura de permisos y control de acceso,
